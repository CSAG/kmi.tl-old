    ...
    <div class="col-md-8 col-md-offset-2" ng-controller="UrlShortenerCtrl">
        ...
        <div class="text-center">
            ...
            <div class="input-group input-group-lg" ng-class="inputUrlClass">
                ...
                <input id="inputUrl" type="text" class="form-control input-lg" placeholder="Parse a link to shorten it"
                       ng-model="inputUrl" ng-keypress="insertUrl($event)" ng-click="clickInputUrl()">
            </div>
            <small class="color-grey text-shadow">All KMI<span class="color-primary">.</span>TL URLs are public and can be shared by anyone.</small>
        </div>
                ...
                <div class="panel-body">
                    <div class="row" ng-repeat="url in urls">
                        <div class="col-md-8 col-xs-6 long-url">
                            <a href="{{url.url}}" title="{{url.url}}">{{url.url}}</a></div>
                        <div class="col-md-3 col-xs-6 long-url">
                            <a href="{{url.alias}}" title="{{url.alias}}">{{ url.alias.replace("http://", "") }}</a>
                        </div>
